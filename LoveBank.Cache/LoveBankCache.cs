...
namespace LoveBank.Cache
{
    /// <summary>
    /// 缓存类
    /// 对缓存进行全局控制管理
    /// </summary>
    public class LoveBankCache
    {
        private static XmlElement objectXmlMap;
        private static ICacheStrategy cs;
        private static volatile LoveBankCache instance = null;
        ...
        /// </summary>
        /// <returns></returns>
        public static LoveBankCache GetCacheService()
        {
            if (instance == null)
            {
                lock (lockHelper)
